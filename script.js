...
fleetBookBtns.forEach(button => {
    button.addEventListener("click", function (e) {
        ...
        selectedFleetAmount = button.closest(".vehicle3").querySelector("h3 label").textContent.trim();
        ...
        // Optional alert
        alert(`You selected ${selectedFleetCar} (${selectedFleetAmount}). Fill your booking details below.`);
    });
});
